...
NB: We're missing emojis for Lesley, Martin, and Su-Hyeon, going from left to right. See [below](#emoji-to-character-mapping) for the emoji mapping for the other characters.
