...
In accordance with the __Tidy Data__ paradigm^[Tidy datasets are easy to manipulate, model and visualize, and have a specific structure: each variable is a column, each observation is a row, and each type of observational unit is a table. https://vita.had.co.nz/papers/tidy-data.html], each row is an observation with a single value for each column/variable.

Since a line of dialog can have multiple speakers, addressees, etc... it may be represented by multiple rows in the data. 
